...
class epicycloid(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Epicycloid", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Epicycloid")
        ...
        self.settings = Qt.QSettings("GNU Radio", "epicycloid")
        ...
        self._b_range = Range(1, 20, 1, 16, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._a_range = Range(1, 20, 1, 17, 200)
        ...
        self.qtgui_const_sink_x_0.set_update_time(1/frequency1)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.audio_sink_1, 1))
        self.connect((self.blocks_complex_to_float_0, 0), (self.audio_sink_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0_1, 0), (self.blocks_sub_xx_0_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_0_1_0, 0), (self.blocks_sub_xx_0_0_0, 1))
        ...
        self.connect((self.blocks_sub_xx_0_0_0, 0), (self.blocks_float_to_complex_0, 0))
    ...
    def set_frequency1(self, frequency1):
        ...
        self.qtgui_const_sink_x_0.set_update_time(1/self.frequency1)
...
def main(top_block_cls=epicycloid, options=None):
